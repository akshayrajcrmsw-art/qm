...
export default function Dashboard() {
  ...
  // Monte Carlo on the dashboard is based on daily candles — fetched here
  // independently of the two DashboardChartPanel instances above (which
  // manage their own weekly/daily data internally) since those don't
  // expose their candles back up to the page. Volume Profile now fetches
  // its own intraday session data internally (see VolumeProfilePanel),
  // so it doesn't need daily candles from here at all.
  ...
  return (
    <main className="dashboard">
      ...
      <div className="row">
        ...
        <div className="slot slot-narrow slot-span2">
          <NseEventsPanel />
        </div>
      </div>
